...
const HeroSection = () => {
  ...
  return (
    <div className="w-full h-[60vh] relative overflow-hidden">
        ...
        <SwiperSlide>
          <div className="h-[60vh] w-full relative">
            ...
            <div className="relative z-10 h-full flex items-center max-w-7xl mx-auto px-6">
              ...
              <div className="text-white max-w-lg animate-fadeInUp">
      ...
      {/* 💎 GLASS ARROWS */}
      <button className="custom-prev absolute left-4 md:left-6 top-1/2 -translate-y-1/2 z-20 backdrop-blur-md bg-white/20 hover:bg-white/30 text-white p-3 md:p-4 rounded-full shadow-lg transition">
        <FaChevronLeft />
      </button>

      <button className="custom-next absolute right-4 md:right-6 top-1/2 -translate-y-1/2 z-20 backdrop-blur-md bg-white/20 hover:bg-white/30 text-white p-3 md:p-4 rounded-full shadow-lg transition">
        <FaChevronRight />
      </button>
